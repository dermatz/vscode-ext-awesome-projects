...
export function getColorPickerHtml(props: ColorPickerProps): string {
    ...
    return `
        <div class="color-container">
            ...
            <button class="button small color-action random-color" onclick="setRandomColor(event, '${escapedId}')" style="display:flex; align-items:center; gap:4px;">
            ...
            <button class="button small color-action" onclick="resetColor(event, '${escapedId}')">
